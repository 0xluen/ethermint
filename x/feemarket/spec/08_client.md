...
```
dailyd query feemarket base-fee [flags]
```

Example:

```
dailyd query feemarket base-fee ...
```
...
```
dailyd query feemarket block-gas [flags]
```

Example:

```
dailyd query feemarket block-gas ...
```
...
```
dailyd query params subspace [subspace] [key] [flags]
```

Example:

```
dailyd query params subspace feemarket ElasticityMultiplier ...
```

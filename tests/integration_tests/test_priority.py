...
def test_native_tx_priority(ethermint):
    ...
    test_cases = [
        {
            ...
            "amount": "1000adaily",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}adaily",
        ...
        },
        {
            ...
            "amount": "1000adaily",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}adaily",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("adaily"))
